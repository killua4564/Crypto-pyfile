...
class AES:
    ...
    def __init__(self, key):
        self.round_keys = [[0] * 16 for _ in range(11)]
        self.round_keys[0] = key

        for i in range(1, 11):
            key_state = self.__sub_bytes(self.round_keys[i-1][-3:] + [self.round_keys[i-1][-4]])
    ...
    def __add_round_key(self, state, round_idx):
        for i in range(16):
    ...
    def encrypt(self, plaintext):
        ...
        for round_idx in range(1, 11):
            ...
            state = self.__add_round_key(state, round_idx)
